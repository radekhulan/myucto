...
Globální registraci odesílací brány spravuje provozovatel systému v kapitole [Odesílací brána ISDS](73b_Odesilaci_brana_ISDS.md). Firma její certifikát ani tajné údaje nevidí.
...
- [Odesílací brána ISDS](73b_Odesilaci_brana_ISDS.md) — globální registrace a provoz brány,
- [Podání a hlášení](58j_Podani_a_hlaseni.md) — mzdové formuláře, jejich stavy a opravy,
- [Nastavení](73_Nastaveni.md) — ostatní nastavení firmy a systému.
