...
## 100.3 Zkušební období a stavy licence
...
## 100.5 Aktivace licenčním klíčem
...
## 100.7 Přenos licence a přeinstalace
...
## 100.8 Přehled dokladů a plateb
...
| **„Tato licence je aktivní na jiné instalaci"** | Klíč běží jinde (typicky po přeinstalaci bez deaktivace). Použij **Aktivovat na této instalaci (přenést)** — viz [§ 100.7](#1007-prenos-licence-a-preinstalace). |
