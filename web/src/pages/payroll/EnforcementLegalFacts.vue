    ...
    <template v-else>
      ...
      <form v-if="showPartyForm" data-test="enforcement-party-form" class="mt-4 rounded-md border border-primary-200 bg-primary-50 p-4" @submit.prevent="appendParty">
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <label class="text-xs font-medium text-neutral-600">{{ t('payroll.enforcement.legal_facts.effective_from') }}<DateInput v-model="party.effective_from" required class="mt-1 w-full rounded-md border border-neutral-300 bg-surface px-3 py-2 text-sm" /></label>
      ...
      <form v-if="showRecipientInstructionForm" data-test="recipient-instruction-form" class="mt-4 rounded-md border border-primary-200 bg-primary-50 p-4" @submit.prevent="appendRecipientInstruction">
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <label class="text-xs font-medium text-neutral-600">{{ t('payroll.enforcement.legal_facts.effective_from') }}<DateInput v-model="recipientInstruction.effective_from" required class="mt-1 w-full rounded-md border border-neutral-300 bg-surface px-3 py-2 text-sm" /></label>
