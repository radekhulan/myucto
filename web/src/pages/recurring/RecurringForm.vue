...
type FormItem = {
  ...
  vat_rate_id: number
  // Ručně zvolená klasifikace DPH (migrace 1788). Prázdné = derivovat ze SSOT při
...
/**
 * Klasifikace DPH na řádku šablony (migrace 1788, nález M-8 auditu VAT klasifikací).
 *
