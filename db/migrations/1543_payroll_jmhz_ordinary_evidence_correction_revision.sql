-- Ordinary evidence follows the current approved payroll revision, including an internal correction revision.
...
BEGIN
  IF NOT EXISTS (
    ...
    SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT = 'JMHZ ordinary evidence requires current approved revision';
  END IF;
END//
