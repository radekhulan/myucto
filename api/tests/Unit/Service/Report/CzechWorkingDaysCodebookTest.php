...
/**
 * P-7 — svátky se čtou z číselníku `public_holidays` (migrace 1783), ne z konstanty.
 *
...
final class CzechWorkingDaysCodebookTest extends TestCase
{
    ...
    /**
     * Pojistka v kódu musí dávat TOTÉŽ co seed migrace 1783 — jinak by odpověď
    ...
    public function testFallbackMatchesSeededCodebook(): void
    {
        ...
        self::assertFalse(CzechWorkingDays::usingFallback());
        self::assertSame($fallback, $fromCodebook, 'Seed migrace 1783 a pojistka v kódu se rozešly.');
    }
    ...
    /**
     * Seed migrace 1783 přepsaný do tvaru pravidel.
     *
