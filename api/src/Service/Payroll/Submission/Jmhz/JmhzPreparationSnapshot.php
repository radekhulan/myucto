...
final readonly class JmhzPreparationSnapshot
{
    ...
    public const PREVIOUS_V13_SCHEMA_REFERENCE = 'payroll-jmhz-preparation-source.v13';
    public const CURRENT_SCHEMA_REFERENCE = 'payroll-jmhz-preparation-source.v14';
