...
final class CatalogJobDispatcher
{
    public const HANDLERS = [
        ...
        'catalog_import_media' => Import\CatalogMediaImportWorker::class,
        'stock_opening_import_stage' => \MyInvoice\Service\Stock\OpeningStockImportWorker::class,
        'stock_opening_import_apply' => \MyInvoice\Service\Stock\OpeningStockImportWorker::class,
